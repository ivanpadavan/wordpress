...
function define_custom_types_structure() {
	...
	if( function_exists('acf_add_local_field_group') ):
		...
		acf_add_local_field_group(array(
			'key' => 'group_5e05c60e91f40',
			'title' => 'event',
			'fields' => array(
				array(
					'key' => 'field_5e05c623dd7f4',
					'label' => 'place',
					'name' => 'place',
					'type' => 'post_object',
					'instructions' => '',
		...
		acf_add_local_field_group(array(
			'key' => 'group_5e05c5a3b2d67',
			'title' => 'place',
			'fields' => array(
				array(
					'key' => 'field_5e05c5b45b433',
					'label' => 'lon',
					'name' => 'lon',
					'type' => 'number',
					'instructions' => '',
