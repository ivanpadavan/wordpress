...
class XO_Event_Calendar_Admin {
	...
	function category_add_form_fields( $taxonomy ) {
		...
		echo '<input id="category_color" class="colorpicker" type="text" name="cat_meta[category_color]" value="' . $color . '" />';
		echo '</div>' . "\n";
	}
	...
	function category_edit_form_fields( $term ) {
		...
		echo '<td><input id="category_color" class="colorpicker" type="text" name="cat_meta[category_color]" value="' . $cat_options['category_color'] . '" />';
		echo '</tr>' . "\n";
	}
					...
					<div class="holiday-edit">
						...
						<?php else: ?>
							...
							<dl>
								...
								<dd>
									<input id="color" class="colorpicker" type="text" name="color" value="<?php echo esc_html( $color ) ?>" />
								</dd>
							</dl>
						<?php endif; ?>
						</div>
